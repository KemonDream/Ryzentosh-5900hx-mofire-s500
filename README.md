...
- cpu:5900hx-es
- gpu:vega8-es
- network:realtek 2.5G and 1G
- wireless:-wifislot bcm94360ng(for airdrop) ax210 200 (for test and normal wifi)
...
- OpenCore 0.9.0 & 0.9.3
 ...
 # Knowing issues:
  ...
  - operating sys encounter black screen sometimes when booting up\
    ...
    Fix: Might because of classic EMI disturbs. Try to use only one power source from display to the machine and prevent multiple groundings. Separate power cables from signal cables may also help solving this issue.
